"""Evaluates the baseline performance of onebyone without RL control.
...
from flow.benchmarks.onebyone import flow_params
from flow.benchmarks.onebyone import N_ROWS
from flow.benchmarks.onebyone import N_COLUMNS


def onebyone_baseline(num_runs, render=False):
...
if __name__ == '__main__':
    runs = 20  # number of simulations to average over
    res = onebyone_baseline(num_runs=runs)
